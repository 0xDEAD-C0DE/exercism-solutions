pub fn translate(input: &str) -> String {
    ...
    for w in input.split_whitespace() {
        ...
        match w {
            ...
            ref w if w.starts_with(['a', 'e', 'i', 'o', 'u']) => word.push_str("ay"),
            ref w if w.starts_with("xr") => word.push_str("ay"),
            ref w if w.starts_with("yt") => word.push_str("ay"),
            ref w if !w.starts_with(['a', 'e', 'i', 'o', 'u']) => {
